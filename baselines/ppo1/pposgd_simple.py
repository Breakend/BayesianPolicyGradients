...
#        ac, vpred = pi.act2(stochastic, ob,LAMBDA)
#        pi.act3( stochastic, ob)
...
def learn(env, policy_func, *,
        ...
        adam_epsilon=1e-5,
        dropout_on_V,dropout_tau_V=0.05,lengthscale_V=0.0015,
    ...
    ret = tf.placeholder(dtype=tf.float32, shape=[None]) # Empirical returLAMBDAn
